...
export class GetApplicationStatsRouteProvider implements RouteProvider<void, ApplicationStatsResponseDto> {
    ...
    provide(): RouteDefinition<void, ApplicationStatsResponseDto> {
        ...
        return {
            name: 'GetOverallApplicationStats',
            method: 'GET',
            path: '/api/v1/stats/application',
            schema,
