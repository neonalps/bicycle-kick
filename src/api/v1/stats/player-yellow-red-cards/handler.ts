...
export class GetPlayerYellowRedCardsStatsRouteHandler implements RouteHandler<GetPlayerCardsRequestDto, PaginatedResponseDto<GetPlayerCardsResponseDto>> {
    ...
    public async handle(_: AuthenticationContext, request: GetPlayerCardsRequestDto): Promise<PaginatedResponseDto<GetPlayerCardsResponseDto>> {
        ...
        const paginatedResult = await this.statsService.getOrderedYellowRedCardsPlayerSum(
            {
