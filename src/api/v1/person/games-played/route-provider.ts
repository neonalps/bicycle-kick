        ...
        const schema: RequestSchema = {
            ...
            querystring: {
                ...
                properties: {
                    ...
                    regulationPenaltiesScored: { type: 'string' },
                    psoPenaltiesFaced: { type: 'string' },
                    psoPenaltiesSaved: { type: 'string' },
                    psoPenaltiesTaken: { type: 'string' },
                    psoPenaltiesScored: { type: 'string' },
